...
public class GroupusersModel {
    ...
    public String getIs_rider() {
        return is_rider;
    }

    public void setIs_rider(String is_rider) {
    ...
    public String getRequested_as_driver() {
        return requested_as_driver;
    }

    public void setRequested_as_driver(String requested_as_driver) {
        this.requested_as_driver = requested_as_driver;
    }
