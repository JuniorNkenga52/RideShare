...
public class NotificationViewActivity extends AppCompatActivity {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    if (response.body().getStatus().equals("success")) {
                        if (response.body().getMsg().get(0).getRequest_status().equals("1")) {
                            ...
                            acceptRider2.setStarting_address(selUser.getStart_address());
                            acceptRider2.setEnding_address(selUser.getEnd_address());
                            ...
                            acceptRider3.setStarting_address(selUser.getStart_address());
                            acceptRider3.setEnding_address(selUser.getEnd_address());
    ...
    private void sendAcceptRejectReq(final JSONObject jMessage) {
        if (mApp.mWebSocketSendRequest != null) {
    ...
    private void getRoutes(final String json) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    Directions directions = new Directions(NotificationViewActivity.this);
    ...
    private boolean checkRoute(List<LatLng> newRoute) {
        ...
        if (exceededTolerance) {
            sendCancelSocketRideRequest(newFromUser.getmUserId());
