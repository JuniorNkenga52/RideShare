...
public class CarBrandAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CarBrandAdapter(Activity act, List<CarBrand> carTypesArray) {
        activity = act;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        CarBrand carYearitem = CarTypesArray.get(position);

        holder.text_caryear.setText("" + carYearitem.getBrand());
