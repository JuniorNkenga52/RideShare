 ...
 */
public class CarMonthAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Activity activity;
    List<CarMonth> CarTypesArray;
    String LanguageCode;
    ...
    public CarMonthAdapter(Activity act, List<CarMonth> carTypesArray) {
        activity = act;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        CarMonth carYearitem = CarTypesArray.get(position);

        holder.text_caryear.setText("" + carYearitem.getMonth());
