...
public class PinEntryEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ? ContextCompat.getColor(context, R.color.white) : ContextCompat.getColor(context, R.color.white);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? ContextCompat.getColor(context, R.color.white) : ContextCompat.getColor(context, R.color.white);
    ...
    protected void updateDrawableState(boolean hasText, boolean isNext) {
        if (mHasError) {
            ...
            mPinBackground.setColorFilter(getResources().getColor(R.color.white), PorterDuff.Mode.OVERLAY);
        } else if (isFocused()) {
